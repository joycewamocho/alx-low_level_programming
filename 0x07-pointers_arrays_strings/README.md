file 0-memse Write a function that fills memory with a constant byte.
...
file 101-crackme_passwordCreate a file that contains the password for the crackme2 executable.
